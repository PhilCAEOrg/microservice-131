 ...
 * 131 - Test Class
 *
 * This class provides a basic testing framework for the microservice 131. It was
...
public class MusicTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Music.class.getCanonicalName(),"0.1");
  ...
  public void testpostSong() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("POST", mainPath + "/song", song.toJSONString(),
  ...
  public void testgetSongs() {
    ...
    try {
      ...
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("GET", mainPath + "/song", "",
